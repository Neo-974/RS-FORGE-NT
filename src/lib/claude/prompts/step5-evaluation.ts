...
Si d'autres organismes seront habilités à former ou évaluer :
- Procédure d'habilitation des partenaires
- Modalités de contrôle de la mise en œuvre par les partenaires (convention, audit)
- Garantie de l'équité de traitement quel que soit le prestataire
- Procédure de révocation d'habilitation si non-conformité
